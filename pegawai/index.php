...
session_start();
if ($_SESSION['isLogin'] != true or $_SESSION['level'] != "pegawai") {
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post" action="#">
                                                            <input type="text" name="keyword" placeholder="Cari Pegawai" value='<?= $keyword ?>'>
                                                            <select name='category'>
                                                                <option value='id' <?php if ($category == "id") echo 'selected' ?>>ID Pegawai</option>
                                            ...
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data as $d) { //foreach adalah perulangan khusus array
                                                        $no++;
                                                        // No special mapping needed for pegawai fields
                                                        $highlightCell = "";
                                                        if (isset($_POST['cari'])) {
                                                        ...
                                                        echo "<tr>
                              <td>$no</td>
                                  <td " . ($category == 'id' ? $highlightCell : "") . ">" . $d['id'] . "</td>
                              ...
                              <td>
                                  ...
                                  <a href='./?p=hapus-pegawai&id=" . $d['id'] . "' class='btn btn-xs btn-danger'>Hapus</a>
                              </td></tr>";
                                                    }
                                                    ?>
                                                </tbody>
